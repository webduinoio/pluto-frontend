      ...
      <div id="menubar">
        <div style="float:left;padding:4px;position:absolute">
          <img
            id="logo"
            height="36"
            src="../webduino_logo.svg"
            style="margin-left:5px"
          />
        </div>
        <div style="padding-top: 10px;">
          <div class="toolMenu">
            <div id="button" class="btn" @click="${this.changeMode}">
