...
new ResizeObserver(function () {
  editor.blockEditor.blockMirror.configuration.height =
    parentElement.offsetHeight;
  editor.textEditor.blockMirror.configuration.height =
    parentElement.offsetHeight;
  ...
  ready(name, obj) {
    ...
    if (name == "wa-range") {
      ...
      range.onSlider(function (value) {
        document.getElementsByClassName("CodeMirror")[0].style["font-size"] =
          value + "px";
...
/*
    ...
    console.log("waUser Obj:", self.coms["waUser"]["check"]);
    self.coms["waUser"].check();
*/